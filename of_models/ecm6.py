...
class EventDataset(Dataset):
    def __init__(self, file_path, height=720, width=1280, chunk_size=100000, max_events=None, temporal_window=10e3, delay=20e3):
    ...
    def preprocess_events(self, events, center_x=640, center_y=360, rf_width=14, rf_height=11, debug=False):
        ...
        if debug:
            print("Number of ON events:", np.sum(on_frame))
            print("Number of OFF events:", np.sum(off_frame))
            print("ON Frame:\n", on_frame)
            print("OFF Frame:\n", off_frame)
